...
/*Часть 2.2 - сумма отрицательных и положительных чисел (с деструктурирующим присваиванием (?))
...
[resultMinus, resultPlus] = summa([1,9,18,15,39,943,1,-1,-5]);
console.log(`Сумма отрицательных чисел: ${resultMinus}`, `Сумма положительных чисел: ${resultPlus}`);
[resultMinus, resultPlus] = summa([0,-2,-3,-10,-3,-4]);
console.log(`Сумма отрицательных чисел: ${resultMinus}`, `Сумма положительных чисел: ${resultPlus}`);
[resultMinus, resultPlus] = summa([0,2,3,10,3,4]);
console.log(`Сумма отрицательных чисел: ${resultMinus}`, `Сумма положительных чисел: ${resultPlus}`);
[resultMinus, resultPlus] = summa([0,0,0,0,0,0]);
console.log(`Сумма отрицательных чисел: ${resultMinus}`, `Сумма положительных чисел: ${resultPlus}`);
*/
